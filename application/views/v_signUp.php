<title>WarunKoffee - Sign Up</title>
...
<div class="container mt-5 mb-0 p-5 rounded">
	...
	<hr style="background-color: transparent;">
	<h3 class="py-3" style="text-align: center;">Sign Up</h3>
	<form class="signUp" action="<?php echo base_url();?>index.php/register/save" method="POST">
	  	...
	  	<div class="container px-5">
			<label for="dob">Account Data</label>
	  		<div class="row mb-4">
			    <div class="col">
			      <div class="input-group">
				  	...
				  	<input name="first_name" type="text" class="form-control" placeholder="First Name" aria-label="Default" aria-describedby="inputGroup-sizing-default">
			  	  </div>
			    </div>
			    <div class="col">
			    	<div class="input-group">
				  		<input name="last_name" type="text" class="form-control" placeholder="Last Name" aria-label="Default" aria-describedby="inputGroup-sizing-default">
			  		</div>
			    </div>
	  		</div>
		  	<div class="input-group mb-4">
			  	...
			  	<input type="email" name="user_email" class="form-control" placeholder="E-Mail" aria-label="Default" aria-describedby="inputGroup-sizing-default">
		  	</div>
		  	<div class="input-group mb-4">
			  	<div class="input-group-prepend">
				    <span class="input-group-text" id="inputGroup-sizing-default">
		  	...
		  	<div class="input-group mb-4">
			  	...
			  	<input type="password" class="form-control" name="confirm_password" placeholder="Confirm Password" aria-label="Default" aria-describedby="inputGroup-sizing-default">
		  	</div>
		  	<hr>
