...
<body>
	...
	<?php } ?> -->
	<nav style="font-family: calibri;" class="navbar fixed-top navbar-expand-lg row navbar-light bg-info shadow-sm p-sm-2 p-0 mb-5">
		<div class="container">
	  		<a class="navbar-brand col-md-2 col-sm-5 mx-sm-5" href="<?php echo base_url();?>index.php/warunkoffeeadmin">
			  <img src="<?php echo base_url();?>assets/img/logo-01.png" alt="Responsive image" width="100em">
			  <h6 class="mx-4 text-white">ADMIN</h6>
			</a>
			<?php error_reporting(0); if ($sessionAdmin != NULL) { ?>
			<div style="text-align: center;" class="collapse navbar-collapse col-md-6 col-lg-8" id="navbarToggleExternalContent">
			    <div style="width: 100%;" class="navbar-nav">
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/warunkoffeeadmin">HOME</a>
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/coffeeadmin">COFFEE</a>
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/foodAdmin">FOOD</a>
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/userAdmin">USER</a>
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/storeAdmin">OUR STORE</a>
			        <a class="nav-item text-white nav-link" href="<?php echo base_url();?>index.php/aboutUsAdmin">ABOUT US</a>
			        <a class="nav-item text-white nav-link d-block d-lg-none" data-toggle="modal" data-target="#searchModal">
			        	SEARCH
			        </a>
			    ...
			    <div style="width: 100%;" class="navbar-nav col-md-3 mx-lg-auto mx-md-5">
			        ...
			        <a href="" class="nav-item text-white nav-link d-none d-lg-block ml-5" data-toggle="modal" data-target="#cartModal">
			        	<i class="fa fa-cart-plus" aria-hidden="true"></i>
			        </a>
			        <div class="dropdown">
					  <a class="nav-item text-white nav-link d-none d-lg-block dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
					  ...
					  <d class="dropdown-menu dropdown-menu-right px-5" aria-labelledby="dropdownMenuButton">
					    <a href="#" class="dropdown-item m-0 w-100 rounded py-3" aria-labelledby="dropdownMenuLink">
					    	<table>
					    		...
					    		<tr>
					    			<td>
					    				<h4 style="color: #F71C1C; text-align: center; font-weight: bold;">
									    	<?php
									    		$arr_name = str_split($admin_name);
									    		if (count($arr_name) >= 20) {
									    			$split_name = explode(" ", $admin_name, 2);
					    ...
					    <hr>	
					  	<div class="dropdown-devider">
					    	...
					    	<a style="text-decoration: none; text-align: justify;" href="<?php echo base_url();?>index.php/logoutAdmin">
	...
	<!-- Copyright -->
	<nav class="nav bg-info px-5 my-5 pt-5 flex-column">
		<div class="container">
			<div class="row">
				<div class="col-3">
				...
				<div class="col-2">
					<a class="nav-link text-light" href="<?php echo base_url();?>index.php/storeAdmin">Location</a>
				</div>
				<div class="col-2">
			...
			<div class="row">
				<div class="my-5 col-12">
					<h6 style="text-align: center; color: #fff;">ADMIN <br> @ 2022</h6>
				</div>
			</div>
		</div>
	</nav>
